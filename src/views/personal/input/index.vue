    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
      ...
      <Card title="基本信息" :padding="0" shadow style="width: 100%; padding-right: 10px" >
        ...
        <Row>
          <Col span="12">
            ...
            <FormItem label="身高" prop="height" >
              <div style="display: inline">
              <InputNumber v-model="formValidate.height" placeholder="请输入身高" style="width: 60px;"></InputNumber>cm
              </div>
            </FormItem>
          ...
          <Col span="12">
            <FormItem label="体重" prop="weight">
              <div style="display: inline">
              <InputNumber v-model="formValidate.weight" placeholder="请输入体重" style="width: 60px;"></InputNumber>kg
              </div>
            </FormItem>
        ...
        <Row>
          <Col span="12">
            ...
            <FormItem label="腰围" prop="waistline">
              <div style="display: inline">
              <InputNumber v-model="formValidate.waistline" placeholder="请输入腰围" style="width: 60px;"></InputNumber>cm
              </div>
            </FormItem>
          ...
          <Col span="12">
            <FormItem label="胸围" prop="bust">
              <div style="display: inline">
              <InputNumber v-model="formValidate.bust" placeholder="请输入胸围" style="width: 60px;"></InputNumber>cm
              </div>
            </FormItem>
          </Col>
        </Row>
        ...
        <Row>
          <Col span="12">
            ...
            <FormItem label="臀围" prop="hipline">
              <div style="display: inline">
              <InputNumber v-model="formValidate.hipline" placeholder="请输入臀围" style="width: 60px;"></InputNumber>cm
              </div>
            </FormItem>
        ...
        <FormItem label="血压" prop="bloodpressure">
          <div style="display: inline">
          <InputNumber v-model="formValidate.bloodpressure" placeholder="请输入血压"></InputNumber>mmHg
          </div>
        </FormItem>
        ...
        <Row>
          <Col span="12">
            <FormItem label="输血" prop="transfusion1">
              <div style="display: inline">
              <InputNumber v-model="formValidate.transfusion1" placeholder="请填写输血量" style="width: 60px;"></InputNumber>ml
              </div>
            </FormItem>
          </Col>
          <Col span="12">
        ...
        <Row>
          <Col span="12">
            <FormItem label="输血" prop="transfusion2">
              <div style="display: inline">
              <InputNumber v-model="formValidate.transfusion2" placeholder="请填写输血量" style="width: 60px;"></InputNumber>ml
              </div>
            </FormItem>
          </Col>
          <Col span="12">
